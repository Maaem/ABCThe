...
<body>
    ...
    <footer class="bg-[#CBDEC0]" aria-labelledby="footer-heading">
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-10 lg:px-8">
            ...
            <div class="md:gap-8">
                <div class="flex justify-center md:flex flex-wrap text-center">
                    <div class="md:mt-0 lg:ml-10 lg:mb-18">
                        <h3 class="text-sm font-semibold text-gray-600 tracking-wider uppercase sm:mr-4">Les pratiques les plus recherchées</h3>
                        <ul role="list" class="mt-4 space-y-4 sm:mr-6">
                            <a href="#" class="text-base text-gray-600 hover:text-gray-600 ml-2 sm:text-justify"> Shiatsu </a>
                    ...
                    <div class="mt-12 md:mt-0 lg:ml-10 lg:mr-6 md:gap-8">
                        <h3 class="text-sm font-semibold text-gray-600 tracking-wider uppercase sm:mr-4">Les maux clés les plus recherchés</h3>
                        <ul role="list" class="mt-4 space-y-4 sm:mr-6" >
            ...
            <div class="flex space-x-6 justify-center mt-8">
                <a href="https://www.facebook.com/AbcTh%C3%A9rapeutes-104488444791022" class="text-gray-600 hover:text-gray-600">
