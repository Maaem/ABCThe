...
<body class="bg-white">
    ...
    <div class="grid grid-cols-3 place-items-center bg-[url('/img/fondbleu1.png')] bg-no-repeat bg-cover text-center rounded-lg sm:p-10 dark:bg-gray-800 dark:border-gray-700 text-gray-600 ">
        ...
        <div class="sm:py-12 sm:px-6 lg:px-8">
            <div class="">
                <h2 class="max-w-xl text-4xl mt-8 mx-auto text-gray-600"">INSCRIPTION</h2>
      </div>
    </div>
            ...
            <div class="my-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div class="bg-white py-8 px-4 drop-shadow-lg sm:rounded-lg sm:px-10">
                    <form class="space-y-6" action="#" method="POST">
                        ...
                        <div>
                            <label for="password" class="block text-sm font-medium text-[#386B96]"> Mot de passe </label>
                            <div class="mt-1">
                        ...
                        <div>
                            <label for="password" class="block text-sm font-medium text-[#386B96]"> Confirmation du mot de passe </label>
                            <div class="mt-1">
                                <input id="password" name="password" type="password" autocomplete="current-password" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 text-[#386B96] focus:ring-indigo-500 border-gray-300 rounded">
                                <label for="remember-me" class="ml-2 block text-sm text-[#386B96]"> J'accepte les CGU & Mentions légales </label>
                            </div>

                        </div>

                        <div>
                            <button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#386B96] hover:bg-[#dde9f4] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">S'inscrire</button>
                        </div>

                        <div class="text-sm text-center">
                            <a href="connexion" class="font-medium text-[#386B96] hover:text-[#dde9f4]"> Vous avez déjà un compte ?Je me connecte </a>
                        </div>
