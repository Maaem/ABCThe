...
<body class="bg-white">
    ...
    <div class="grid grid-cols-3 place-items-center bg-[url('/img/fondbleu1.png')] bg-no-repeat bg-cover text-center rounded-lg sm:p-10 dark:bg-gray-800 dark:border-gray-700 text-gray-600 ">
        ...
        <div class="sm:py-12 sm:px-6 lg:px-8">
            <div class="">
                <h2 class="max-w-xl text-4xl mt-8 mx-auto text-gray-600"">CONNEXION</h2>
      </div>
    </div>
                    ...
                    <form class="space-y-6" action="#" method="POST">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <label for="remember-me" class="ml-2 block text-sm text-[#386B96]"> Me garder connecté </label>
                            </div>

                        </div>

                        <div>
                            <button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#386B96] hover:bg-[#dde9f4] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Se connecter</button>
                        </div>

                        <div class="text-sm text-center">
                            <a href="mdp" class="font-medium text-[#386B96] hover:text-[#dde9f4]"> Mot de passe oublié </a>
                        </div>

                        <div class="text-sm text-center">
                            <a href="inscription" class="font-medium text-[#386B96] hover:text-[#dde9f4]"> Créer son compte maintenant ! </a>
                        </div>
                    </form>
